...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:filePath                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,scrawlPath:filePath                            //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:URL+"jsp/fileUp.jsp"               //附件上传提交地址
        ,filePath:filePath                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数
         //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        ,catcherUrl:URL +"jsp/getRemoteImage.jsp"   //处理远程图片抓取的地址
        ,catcherPath:filePath                  //图片修正地址，同imagePath
        ...
        ,imageManagerPath:filePath                                    //图片修正地址，同imagePath
        ...
        ,toolbars:[["fullscreen","source","|","undo","redo","|","bold","italic","underline","strikethrough","superscript","subscript","|","justifyleft","justifycenter","justifyright","justifyjustify","|","imagenone","imageleft","imageright","imagecenter","|","indent","rowspacingbottom","rowspacingtop","lineheight"],["paragraph","fontfamily","fontsize","forecolor","backcolor","|","insertunorderedlist","insertorderedlist","|","unlink","link","insertimage","insertvideo","attachment","wordimage"],["inserttable","deletetable","mergeright","mergedown","splittorows","splittocols","splittocells","mergecells","insertcol","insertrow","deletecol","deleterow","insertparagraphbeforetable"],[]]
...
//           ]
    ...
    //字数统计提示，{#count}代表当前字数，{#leave}代表还可以输入多少字符数,留空支持多语言自动切换，否则按此配置显示
        ...
        ,minFrameWidth:880    //编辑器拖动时最小宽度,默认800
