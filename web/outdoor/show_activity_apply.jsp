...
<html>
	...
	<form action="approveActivityApply.do?applyId=<%=entity.getID()%>&type=<%=message.getApproveType()%>" id="approveForm" method="post">
		...
		<option value="1">[室外活动]同意，请注意不要影响交通。请到校团委门厅领取审批表，并交到C楼107物业中心综合治理办公室审批，电话62785656。</option>
		<option value="2">[展板]同意。请到校团委领取审批表交至环保办（62783077善斋312房间）审批。室外宣传品请注意以下事项：1.地点不得阻碍交通，不得立于道路交叉口黄色区域，如在区域内，环保办和保卫处将及时清理；2.展板规格不超过 2*3m，数量1块，放置不超过7天，到期及时撤架。逾期2日内环保办进行撤除清理并暂停申请方申请资格；3.展板应干净整洁，粘贴的小广告需负责清理；4.展板须确保牢固， 大风天气要加强检查防范；不能压着小树苗。谢谢大家。我们共同努力，让校园更美好！</option>
