...
<html>
    ...
    <ol>
	<li>由于审批系统新旧交替，新学清审批系统计划于<span class="redtext">3月25日（周一）</span>正式开始启用：此前提交的申请，将在25号新审批系统启用后进行处理。如您的申请时间比较紧，建议选择其它的方式进行审批，以免耽误活动安排。 给您带来的不便，请谅解！感谢大家对新学清的支持与帮助！</li>
